...
import jp.shido.flutter_work_manager.WorkManagerCall.CancelTask.ByTag.KEYS.UNREGISTER_TASK_TAG_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.CancelTask.ByUniqueName.KEYS.UNREGISTER_TASK_UNIQUE_NAME_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.Initialize.KEYS.INITIALIZE_TASK_CALL_HANDLE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.Initialize.KEYS.INITIALIZE_TASK_IS_IN_DEBUG_MODE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_BACK_OFF_POLICY_DELAY_MILLIS_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_BACK_OFF_POLICY_TYPE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_CONSTRAINTS_BATTERY_NOT_LOW_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_CONSTRAINTS_CHARGING_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_CONSTRAINTS_DEVICE_IDLE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_CONSTRAINTS_NETWORK_TYPE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_CONSTRAINTS_STORAGE_NOT_LOW_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_EXISTING_WORK_POLICY_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_INITIAL_DELAY_SECONDS_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_IS_IN_DEBUG_MODE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_NAME_VALUE_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_TAG_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.KEYS.REGISTER_TASK_UNIQUE_NAME_KEY
import jp.shido.flutter_work_manager.WorkManagerCall.RegisterTask.PeriodicTask.KEYS.PERIODIC_TASK_FREQUENCY_SECONDS_KEY
...
data class BackoffPolicyTaskConfig(val backoffPolicy: BackoffPolicy,
    ...
    companion object {
        val defaultPeriodicBackoffTaskConfig =
                BackoffPolicyTaskConfig(
                        defaultBackOffPolicy,
                        defaultRequestedBackoffDelay,
                        TaskType.PERIODIC.minimumBackOffDelay
                )
...
object Extractor {
    ...
    fun extractWorkManagerCallFromRawMethodName(call: MethodCall): WorkManagerCall =
            when (Extractor.PossibleWorkManagerCall.fromRawMethodName(call.method)) {
